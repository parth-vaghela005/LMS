        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <Input
              ...
              className="flex-grow border-none px-6 py-3 text-gray-900 placeholder-gray-400"
            />
            <Button
              type="submit"
              className="bg-gray-800 text-white px-6 py-3 rounded-r-full hover:bg-blue-700"
            >
              Search
            </Button>
          </form>
